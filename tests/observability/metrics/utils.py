...
def parse_vm_metric_results(raw_output: str) -> dict:
    """
...
def assert_validate_vm_metric(vm: VirtualMachineForTests, metrics_list: list) -> None:
    """
...
def get_topk_query(metric_names: list, time_period: str = "5m") -> str:
    """
...
def assert_instancetype_labels(prometheus_output: dict, expected_labels: dict) -> None:
    """
...
def assert_virtctl_version_equal_metric_output(virtctl_server_version: dict, metric_output: dict) -> None:
    mismatch_result = []
